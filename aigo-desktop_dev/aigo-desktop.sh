...
if [ -f /etc/iptables/rules.v4 ] ; then
  cp -a /etc/iptables/rules.v4 /etc/iptables/rules.v4.RaspAP
...
cp -a /etc/dhcpcd.conf /etc/dhcpcd.conf.RaspAP
...
cp -a /etc/dnsmasq.d/090_wlan0.conf /etc/dnsmasq.d/090_wlan0.conf.RaspAP
